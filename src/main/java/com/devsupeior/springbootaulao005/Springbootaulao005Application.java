package com.devsupeior.springbootaulao005;
...
public class Springbootaulao005Application implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(Springbootaulao005Application.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null,"Domain Driven Design",1200.00,cat2);
